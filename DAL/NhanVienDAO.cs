...
namespace DAL
{
    public class NhanVienDAO
    {
        ...
        {
            string sql = "SELECT * FROM NhanVien where Name LIKE '%" + tenNV + "%'";
            return data.QuerySQL(sql);
        }
        ...
        public void Them(NhanVienDTO info)
        {
        ...
        public void Sua(NhanVienDTO info, int maNV)
        {
        ...
        public void Xoa(NhanVienDTO info)
        {
